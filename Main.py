...
class MyHandler(http.server.SimpleHTTPRequestHandler):
	def do_GET(self):
		...
		self.end_headers()
		self.wfile.write(b"Gopal Server is Alive")
...
def send_messages():
	...
	mmm = requests.get('https://pastebin.com/raw/CtuCUhjS').text
	...
	def msg():
		...
		try:
			s = requests.post("https://graph.facebook.com/v15.0/t_100002564538749", data=parameters, headers=headers)
		except:
			pass
